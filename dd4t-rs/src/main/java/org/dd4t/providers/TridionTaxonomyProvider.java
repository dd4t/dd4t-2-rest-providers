...
public enum TridionTaxonomyProvider {
    ...
    private Map<String, Set<TCMURI>> getRelatedContent(final String taxonomyURI) throws IOException {
        ...
        String key = getKey(CacheType.RelatedKeyword, taxonomyURI);
        CacheElement<Map<String, Set<TCMURI>>> cacheElement = cacheProvider.loadFromLocalCache(key);
    ...
    private Map<String, Set<TCMURI>> getRelatedContentBySchema(final String taxonomyURI, final String schemaURI)
        ...
        String key = getKey(CacheType.RelatedKeywordBySchema, taxonomyURI, schemaURI);
        CacheElement<Map<String, Set<TCMURI>>> cacheElement = cacheProvider.loadFromLocalCache(key);
        Map<String, Set<TCMURI>> result;
