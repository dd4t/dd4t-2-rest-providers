...
import org.dd4t.providers.TridionComponentProvider;
...
public class ComponentProviderService {
    ...
    public String getComponentPresentationById(@PathParam ("componentId") final int componentId,
        ...
        String result = null;
        try {
            result = TridionComponentProvider.INSTANCE.getDynamicComponentPresentation(componentId, templateId, publicationId);
        } catch (IOException e) {
