...
import org.dd4t.providers.TridionPageProvider;
 ...
 * <p/>
 * We use Resteasy 2.3.6 because Tom Tom uses JBoss EAP 6.1. Ideally its moved to 3.0.x
 *
 * @author R. Kempees
 * @since 01.05.2014
 */
...
public class PageProviderService {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(org.dd4t.providers.rs.PageProviderService.class);
    ...
    public String getPageContentById(@PathParam ("itemId") final int id,
        ...
        String result = null;
        try {
            result = TridionPageProvider.INSTANCE.getPageContentById(id, publication);
    ...
    public String getPageContentByURL(@PathParam ("url") String url,
        ...
        String result = null;
        try {
            result = TridionPageProvider.INSTANCE.getPageContentByURL(url, publication);
        } catch (StorageException | IOException e) {
            LOG.error("Error fetching page", e);
        } catch (ItemNotFoundException e) {
    ...
    public String getPageListByPublicationId(@PathParam ("publicationId") int publication,
        ...
        String result = null;
        try {
            result = TridionPageProvider.INSTANCE.getPageListByPublicationId(publication);
    ...
    public Integer checkPageExists(@PathParam ("url") String url,
        ...
        Integer result = 0;
        try {
            return TridionPageProvider.INSTANCE.checkPageExists(url, publication);
