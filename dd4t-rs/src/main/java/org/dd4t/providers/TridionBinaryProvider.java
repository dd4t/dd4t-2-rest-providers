 ...
 * @since 04.06.14
 */
public enum TridionBinaryProvider {
    ...
    public byte[] getBinaryContentById(final int id, final int publication)
        ...
        String key = getKey(CacheType.BinaryContent, id, publication);
        CacheElement<byte[]> cacheElement = cacheProvider.loadFromLocalCache(key);
        byte[] result;
    ...
    public byte[] getBinaryContentByURL(final String url, final int publication)
        ...
        String key = getKey(CacheType.BinaryContent, decodedUrl, publication);
        CacheElement<byte[]> cacheElement = cacheProvider.loadFromLocalCache(key);
        byte[] result;
    ...
    public String getBinaryMetaById(int id, int publication)
        ...
        String key = getKey(CacheType.BinaryMeta, id, publication);
    ...
    public String getBinaryMetaByURL(String url, int publication)
        ...
        String decodedUrl = decodeUrl(url);
        String key = getKey(CacheType.BinaryMeta, decodedUrl, publication);
        CacheElement<String> cacheElement = cacheProvider.loadFromLocalCache(key);
        String result = null;
    ...
    public int discoverPublicationId(final String imagesUrl)
        ...
        String key = getKey(CacheType.DiscoverImagesURL, decodedUrl);
